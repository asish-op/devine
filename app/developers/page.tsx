...
import { DeveloperDirectory } from "../components/LivePropertyGrid";
import { developers, indiaPartners, uaePartners } from "../data";
...
export default function DevelopersPage() {
  return <main id="top">
    ...
    <section className="partner-regions section"><div className="shell">
      <div className="partner-region"><div className="partner-region-head"><span className="eyebrow light">Our partners</span><h2>United Arab Emirates</h2><strong>40+</strong></div><div className="partner-cloud">{uaePartners.map((partner) => <span key={partner}><img src={`/images/partners/${logoFile(partner)}.png`} alt={partner} loading="lazy" /></span>)}</div><p className="partner-more">And more</p></div>
      <div className="partner-region"><div className="partner-region-head"><span className="eyebrow light">Our partners</span><h2>India</h2><strong>20+</strong></div><div className="partner-cloud">{indiaPartners.map((partner) => <span key={partner}><img src={`/images/partners/${logoFile(partner)}.png`} alt={partner} loading="lazy" /></span>)}</div><p className="partner-more">And more</p></div>
    </div></section>

    <section className="section featured-partners"><div className="shell"><div className="section-heading"><div><span className="eyebrow">Featured relationships</span><h2>Explore selected partners.</h2></div><p>Discover profiles and current opportunities from a selection of our established developer relationships.</p></div><DeveloperDirectory developers={developers} /></div></section>
